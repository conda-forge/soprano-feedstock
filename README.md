...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/soprano-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14470&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/soprano-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `soprano` can be installed with:

```
conda install soprano
```

It is possible to list all of the versions of `soprano` available on your platform with:
